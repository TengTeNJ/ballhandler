    ...
    if (response.success && response.data['data'] != null) {
      ...
      _array.forEach((element) {
        ...
        model.messageTitle = !ISEmpty(_map['messageTitle'])
            ...
            : '--';
        model.pushId = !ISEmpty(_map['pushId']) ? _map['pushId'] : 0;
        model.isRead = !ISEmpty(_map['isRead']) ? _map['isRead'] : 0;
        _list.add(model);
      });
      _model.count =
  ...
  static Future<ApiResponse<ActivityDetailModel>> queryIActivityDetailData(
    ...
    if (response.success && response.data['data'] != null) {
      ...
      model.endDate = !ISEmpty(_map['endDate'])
          ...
          : '';
      model.isJoin = !ISEmpty(_map['isJoin']) ? _map['isJoin'] : 0;
      model.sceneId =
      ...
      if (model.activityStatus != 0) {
        ...
        self.country = await NSUserDefault.getValue(kCountry);
        self.avgPace =
            !ISEmpty(_map['avgPace']) ? _map['avgPace'].toString() : '-';
        self.avgPace =
            !ISEmpty(_map['avgPace']) ? _map['avgPace'].toString() : '-';
        ...
        self.trainVideo =
            !ISEmpty(_map['trainVideo']) ? _map['trainVideo'].toString() : '';
        self.createTime = !ISEmpty(_map['createTime'])
            ? StringUtil.serviceStringToShowDateString(
      ...
      if (model.activityStatus == 2) {
        ...
        championModel.championAvgPace = !ISEmpty(_map['championAvgPace'])
            ? _map['championAvgPace'].toString()
            : '0';
        ...
        championModel.championTrainVideo = !ISEmpty(_map['championTrainVideo'])
            ...
            : '';
        championModel.createTime = !ISEmpty(_map['championCreateTime'])
            ? StringUtil.serviceStringToShowDateString(
                _map['championCreateTime'].toString())
            : '-';
