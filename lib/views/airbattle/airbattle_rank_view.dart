...
class _AirbattleRankViewState extends State<AirbattleRankView> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      color: widget.model.memberId == UserProvider.of(context).userId
          ? hexStringToOpacityColor('#B6C5F6', 0.51)
          : null,
      child: Row(
        ...
        children: [
          Row(
            ...
            children: [
                  ...
                  ? Container(
                      ...
                      child: Stack(
                        children: [
                          Image(
                            image: AssetImage(
                                'images/airbattle/rank${widget.rank}.png'),
                            fit: BoxFit.fill,
                          ),
                          Positioned(
                              left: 5,
              ...
              Container(
                width: Constants.screenWidth(context) - 280,
                child: Constants.mediumWhiteTextWidget(
                    widget.model.nickName ?? '', 20),
              ),
              SizedBox(
                width: 8,
              ),
