...
class RazorP2SelectController extends StatefulWidget {
  ...
  @override
  State<RazorP2SelectController> createState() =>
      _RazorP2SelectControllerState();
}

class _RazorP2SelectControllerState extends State<RazorP2SelectController> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Constants.mediumGreyTextWidget(
                            'Please select 5-6 training modes and combine them into one free mode for training',
                            14,
                            height: 1.2,
