...
class CareerDetailPageController extends StatefulWidget {
  ...
  @override
  State<CareerDetailPageController> createState() =>
      _CareerDetailPageControllerState();
}

class _CareerDetailPageControllerState
    extends State<CareerDetailPageController> {
  int _score = 1000;
